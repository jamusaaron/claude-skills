---
name: deep-research
description: Run a production research-ops pipeline for complex, ambiguous, contested, or high-stakes questions. Decompose the query, plan searches, score source credibility, triangulate claims across independent lineages, detect contradictions, measure coverage/freshness gaps, and package layered outputs (executive brief, synthesis memo, annotated bibliography, full report) with uncertainty bands and an audit trail. Use when the user asks for deep research, a comprehensive investigation, multi-source synthesis, evidence-backed fact-check, balanced report on a controversial topic, policy or scientific literature review, executive briefing, or any answer that must be traceable rather than a first-page summary.
---
