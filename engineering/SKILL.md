...
description: "26 advanced POWERFUL-tier engineering skills covering agent design, RAG architecture, deep research, MCP servers, CI/CD pipelines, database design, observability, security auditing, release management, and platform operations. Works with Claude Code, Codex CLI, and OpenClaw."
version: 1.1.0
